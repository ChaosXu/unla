...
## 1. 基础API服务 ([api.ts](file:///Users/chaosxu/code/github.com/chaosxu/unla/web/src/services/api.ts))
...
## 2. MCP服务 ([mcp.ts](file:///Users/chaosxu/code/github.com/chaosxu/unla/web/src/services/mcp.ts))

这个文件封装了与MCP协议相关的操作：

- `connect(config, authToken?, headerName?)` - 连接到MCP服务器
- [reconnect(serverName)](file:///Users/chaosxu/code/github.com/chaosxu/unla/web/src/services/mcp.ts#L119-L130) - 重新连接到MCP服务器
- [getTools(serverName)](file:///Users/chaosxu/code/github.com/chaosxu/unla/web/src/services/mcp.ts#L132-L147) - 获取MCP服务器工具列表
- `callTool(serverName, toolName, args, onLastEventIdUpdate?)` - 调用MCP工具
- [terminateSession(serverName)](file:///Users/chaosxu/code/github.com/chaosxu/unla/web/src/services/mcp.ts#L195-L212) - 终止MCP会话
- [disconnect(serverName)](file:///Users/chaosxu/code/github.com/chaosxu/unla/web/src/services/mcp.ts#L214-L237) - 断开与MCP服务器的连接
- [disconnectAll()](file:///Users/chaosxu/code/github.com/chaosxu/unla/web/src/services/mcp.ts#L239-L242) - 断开所有MCP连接

## 3. LLM聊天服务 ([llm-chat.ts](file:///Users/chaosxu/code/github.com/chaosxu/unla/web/src/services/llm-chat.ts))

这个文件封装了与LLM聊天相关的功能：

- `sendMessage(provider, messages, modelId?, availableTools?, onChunk?, onReasoningChunk?, onToolCall?, onComplete?, onError?)` - 发送消息到LLM
- [callTool(toolName, parameters)](file:///Users/chaosxu/code/github.com/chaosxu/unla/web/src/services/mcp.ts#L149-L193) - 调用工具（会调用MCP服务的callTool方法）
